...
export function EnergiaMotores() {
  const products = getProductsByDivision('/soluciones/energia-motores');
  ...
  return <div className="bg-[#0a1628] min-h-screen">
      <section className="relative pt-32 pb-20 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-b from-yellow-700/20 to-transparent"></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          duration: 0.8
            ...
            <p className="text-xl text-slate-400 max-w-3xl leading-relaxed mb-8">
              Potencia y eficiencia para su industria. Motores eléctricos,
              generadores y soluciones de energía.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="md:col-span-2">
              ...
              once: true
                ...
                <p className="text-slate-400 mb-6 leading-relaxed text-lg">
                  Suministramos motores de alta eficiencia (IE2, IE3, IE4) que
                  reducen el consumo eléctrico y la huella de carbono.
                </p>
                <h3 className="text-lg font-bold text-white mb-4">
                  Portafolio:
                </h3>
                <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  {['Motores Eléctricos AC/DC', 'Motorreductores', 'Variadores de Frecuencia', 'Arrancadores Suaves', 'Plantas Eléctricas', 'Transformadores'].map((item, i) => <li key={i} className="flex items-center text-slate-300">
            ...
            once: true
              ...
              <ul className="space-y-4">
                {['Bobinado y reparación de motores', 'Análisis de calidad de energía', 'Mantenimiento de generadores'].map((service, i) => <li key={i} className="flex items-start">
      ...
      <DivisionVideo videoName="energiamotores" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          once: true
            ...
            <h2 className="text-4xl font-bold text-white mb-4">
              Catálogo de <span className="text-yellow-400">Motores</span>
            </h2>
          ...
          once: true
            ...
            <h3 className="text-xl font-bold text-white mb-2">
              ¿Necesita un motor especial?
            </h3>
            <p className="text-slate-400 mb-6">
              Motores a prueba de explosión, acero inoxidable o voltajes
              especiales.
            </p>
