  ...
  return <motion.div initial={{
    ...
    y: -5
      ...
      <div className="aspect-square bg-gradient-to-br from-slate-700/50 to-slate-800/50 flex items-center justify-center relative overflow-hidden">
        <img src={image || 'https://i.imgur.com/PyMsJVu.png'} alt={name} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" />
      </div>
      <div className="p-5">
        ...
        <Button onClick={() => openWhatsAppForProduct(name)} variant="outline" size="sm" className="w-full text-white border-slate-600 hover:border-blue-500 hover:text-blue-400 hover:bg-transparent group/btn">
